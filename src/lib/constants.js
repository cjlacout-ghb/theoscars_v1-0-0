export const SUPABASE_URL = "https://lezdpqvgizwocanjeray.supabase.co";
export const SUPABASE_KEY = "sb_publishable_U1MphUk0VKWQCLJFIJSeBg_L2h7F08X";
...
export const EMOJIS = ["🦁", "🌙", "⭐", "🎭", "🍿", "🎬", "🏆", "🌹", "💎", "👑", "🦋", "🎪"];
export const ADMIN_PASSWORD = "oscars2026";
